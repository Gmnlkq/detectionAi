...
constexpr auto qt_meta_stringdata_CLASSLeftWidgetENDCLASS = QtMocHelpers::stringData(
    "LeftWidget",
    "slotShowPoint",
    "",
    "MyPoint&",
...
void LeftWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->slotShowPoint((*reinterpret_cast< std::add_pointer_t<MyPoint&>>(_a[1]))); break;
        case 1: _t->slotGetNum((*reinterpret_cast< std::add_pointer_t<int>>(_a[1]))); break;
        default: ;
        }
    }
}
